      ...
      <section class="content-header">
        <div class="container-fluid" style="text-align:center; font-weight:bold;">
          <div class="col-md-12 bg-warning title mb-2">
            <h1 style="color: black;">Diskon Bulanan</h1>
          </div>
        </div>
      </section>
      <div class="container">
          ...
          @foreach ($menu as $data)
            @if ($data->kategori == "Diskon")
              <div class="col-md-6" data-aos="fade-right">
                <div class="card d-flex flex-row bg-dark cardDiskon">
                  <img src="{{asset("storage/assets/$data->gambar")}}" alt="menu" class="gambarDiskon mt-3" alt="diskon">
                  <div class="infoRekomendasi mt-2 ml-2">
                    <h6>{{ $data->nama }}</h6>
                    ...
                    <form action="/adminDiskon/{{ $data->id }}" method="POST" class="d-inline">
                      @method('delete')
                      @csrf
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body" style="text-align: left">
                    <form action="/adminDiskon/edit/{{ $data->id }}" method="POST">
                      @method('patch')
                      @csrf
                      <div class="mb-3">
